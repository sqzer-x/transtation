...
Your own VLESS + REALITY proxy with optional Cloudflare WARP egress, on any
Linux box. The server runs in a container or natively, whichever you prefer;
the client is a native install, because putting a machine behind a proxy means
